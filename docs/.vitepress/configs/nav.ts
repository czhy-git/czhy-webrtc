 ...
 * @LastEditors: WangLi
 * @LastEditTime: 2026-04-09 05:37:32
 */
...
export const nav: DefaultTheme.Config['nav'] = [
  ...
  },
  {
    ...
    items: [
      {
        text: 'CHANGELOG',
        link: 'https://github.com/czhy-git/czhy-webrtc/blob/main/CHANGELOG.md'
      },
      {
        text: 'V1',
        link: 'https://czhy.github.io/czhy-webrtc/v1/'
      },
      {
        text: '历史版本',
        link: 'https://github.com/czhy-git/czhy-webrtc/releases'
      }
    ]
  }
]
